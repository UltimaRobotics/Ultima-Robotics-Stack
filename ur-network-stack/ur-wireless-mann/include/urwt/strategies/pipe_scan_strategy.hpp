#ifndef URWT_STRATEGIES_PIPE_SCAN_STRATEGY_HPP
#define URWT_STRATEGIES_PIPE_SCAN_STRATEGY_HPP
...
class PipeScanStrategy : public ScanStrategy {
public:
    explicit PipeScanStrategy(std::shared_ptr<ProcessExecutor> executor = nullptr);
