#ifndef URWT_RPC_GET_WIRELESS_CONFIG_HANDLER_HPP
#define URWT_RPC_GET_WIRELESS_CONFIG_HANDLER_HPP
...
class GetWirelessConfigHandler : public IRequestHandler {
public:
    ...
    ~GetWirelessConfigHandler() override;
...
#endif // URWT_RPC_GET_WIRELESS_CONFIG_HANDLER_HPP
