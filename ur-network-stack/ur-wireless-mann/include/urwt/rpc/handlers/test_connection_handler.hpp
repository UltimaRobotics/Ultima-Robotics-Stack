#ifndef URWT_RPC_TEST_CONNECTION_HANDLER_HPP
#define URWT_RPC_TEST_CONNECTION_HANDLER_HPP
...
class TestConnectionHandler : public IRequestHandler {
public:
    ...
    ~TestConnectionHandler() override;
...
private:
    ...
    void performTestInThread(const std::string& transactionId, const std::string& interfaceName, const std::string& ssid);
};

} // namespace rpc
} // namespace urwt

#endif // URWT_RPC_TEST_CONNECTION_HANDLER_HPP
