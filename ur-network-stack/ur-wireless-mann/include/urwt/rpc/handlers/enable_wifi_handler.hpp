#ifndef URWT_RPC_ENABLE_WIFI_HANDLER_HPP
#define URWT_RPC_ENABLE_WIFI_HANDLER_HPP
...
class EnableWifiHandler : public IRequestHandler {
public:
    EnableWifiHandler(
...
private:
    ...
    void performEnableWifiInThread(const std::string& transactionId, const std::string& interface);
};

} // namespace rpc
} // namespace urwt

#endif // URWT_RPC_ENABLE_WIFI_HANDLER_HPP
