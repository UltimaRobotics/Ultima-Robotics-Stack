#ifndef URWT_RPC_LIST_SAVED_NETWORKS_HANDLER_HPP
#define URWT_RPC_LIST_SAVED_NETWORKS_HANDLER_HPP
...
class ListSavedNetworksHandler : public IRequestHandler {
public:
    ...
    ~ListSavedNetworksHandler() override;
...
#endif // URWT_RPC_LIST_SAVED_NETWORKS_HANDLER_HPP
