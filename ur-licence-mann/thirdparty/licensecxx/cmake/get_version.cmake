...
execute_process(
    ...
    RESULT_VARIABLE GIT_DESCRIBE_ERR
    OUTPUT_STRIP_TRAILING_WHITESPACE
    ERROR_QUIET
)

# If git command fails or no tags, set default version
if(GIT_DESCRIBE_ERR OR "${GIT_DESCRIBE}" STREQUAL "")
...
string(REGEX MATCH "v[0-9]+\\.[0-9]+\\.[0-9]+" SEMVER_FOUND ${GIT_DESCRIBE})
...
if("${SEMVER_FOUND}" STREQUAL "")
    ...
    if(VER_NUMBERS_LEN GREATER_EQUAL 3)
