...
Usage: python test_delete_operation.py <instance_name>
"""
...
def test_delete(instance_name):
    """Test deleting a VPN instance via RPC"""
    test = BaseRPCTest()
    ...
    try:
        ...
        response = test.send_rpc_request("delete", params)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python test_delete_operation.py <instance_name>")
        sys.exit(1)
    
    instance_name = sys.argv[1]
    
    success = test_delete(instance_name)
